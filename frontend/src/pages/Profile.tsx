      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="glass-card rounded-xl p-6 text-center max-w-md">
          ...
          <button
            ...
            className="px-4 py-2 bg-gradient-to-r from-[#a855f7] to-[#06b6d4] rounded-lg text-white font-semibold hover:scale-105 transition-transform"
          >
            Go to feed
          </button>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="glass-card rounded-xl p-6 mb-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
              {/* Avatar */}
              <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#a855f7] to-[#06b6d4] flex items-center justify-center overflow-hidden flex-shrink-0">
